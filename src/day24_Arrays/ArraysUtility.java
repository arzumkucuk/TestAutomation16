...
public class ArraysUtility {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(arr); // bu sekilde array sout alinmaz

        System.out.println(Arrays.toString(arr)); // Array sout bu sekilde cikar
       ...
       // System.out.println(nums); // bu sekilde yazdirmaz
