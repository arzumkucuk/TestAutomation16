...
public class RelationalOperators {
    public static void main(String[] args) {
        ...
        System.out.println( 10 >= 10); // 10 is greater or equal to 10

        System.out.println( 10 < 9 ); // false
        System.out.println( 10 <= 9); // 10 is less than or equal to 9
        ...
        //    Even number : if any number can be evenly divisible by 2 with 0 remainder

        boolean isOdd = x % 2 != 0; // opposite of even

        // System.out.println("10" > 9); bu sekilde yazamazsin
