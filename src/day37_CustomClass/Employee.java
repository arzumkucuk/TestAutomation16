...
public class Employee {
    ...
    public String name, company, jobTitle, ID;
    public char gender;
    public int weeklyHours;
    public double hourlyRate, salary;

    public void setInfo(String name, String company, String jobTitle, String ID, char gender, int weeklyHours, double hourlyRate) {
        this.name = name;
