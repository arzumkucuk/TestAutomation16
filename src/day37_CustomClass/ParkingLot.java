...
public class ParkingLot { // HAS A RELATION
    ...
    public static void main(String[] args) {
        ...
        cars[0].setInfo("BMW", "i8","Black", LocalDate.of(2015,5,20), 20000,100000);
        cars[1].setInfo("BMW", "m4","Black", LocalDate.of(2016,6,20), 20000,100000);
        cars[2].setInfo("BMW", "m4","Black", LocalDate.of(2017,7,20), 20000,100000);
        cars[3].setInfo("BMW", "i8","Black", LocalDate.of(2018,8,20), 20000,100000);
        cars[4].setInfo("BMW", "x5","Black", LocalDate.of(2019,9,20), 20000,100000);
        ...
        System.out.println("=========================================================================");
        // recall ALL BMW that were build before 2016
